...
class SubmitButton extends Component {
  render() {
    ...
    return (
    <div >
      <Button className="submitButton" type="submit" variant="contained" color="primary" onClick={this.props.login} disabled={this.props.checkValue}>{this.props.label}</Button>
    </div>
    );
  }
}
